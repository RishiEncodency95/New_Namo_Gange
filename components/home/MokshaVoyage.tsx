      ...
      <div className="w-full px-2 md:px-12  lg:px-12 py-2 md:py-6 flex flex-col md:flex-row items-center gap-2 md:gap-12">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-2 text-gray-700 text-base md:text-sm leading-relaxed text-justify">
            <p className="text-[13px] md:text-sm text-gray-600 italic mb-3 text-center">
          ...
          <Link href="/about">
            <button
              className="mt-2 md:mt-3 lg:mt-3 relative rounded overflow-hidden px-4 md:px-6 py-1 text-[12px] md:text-sm text-white font-normal 
        ...
        >
          <div className="overflow-hidden rounded shadow-lg hover:shadow-xl transition-all duration-500">
            <Image
              ...
              className="w-full md:h-100 object-cover hover:scale-103 transition-transform duration-700 ease-in-out"
            />
          </div>
